...
import { Plus, Calendar, Trash2, TrendingUp, Briefcase, Landmark, Coins, Wallet, Bitcoin, Save, FileText, ChevronDown, ChevronUp, Loader2, ChevronLeft, ChevronRight, Activity } from 'lucide-react';
